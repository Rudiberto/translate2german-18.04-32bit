...
sudo rpl 'i> Donate' 'i> Spenden' /var/www/html/admin/scripts/pi-hole/php/header.php
...
sudo rpl '<kbd>Return</kbd>' '<kbd>Enter</kbd>' /var/www/html/admin/scripts/pi-hole/php/loginpage.php
sudo rpl 'Log in and go to requested page' 'Anmelden und zur gewünschten Seite gehen' /var/www/html/admin/scripts/pi-hole/php/loginpage.php
sudo rpl '<kbd>Ctrl</kbd>' '<kbd>Strg</kbd>' /var/www/html/admin/scripts/pi-hole/php/loginpage.php
sudo rpl 'Log in and go to Settings page' 'Anmelden und zur Einstellungsseite gehen</p>' /var/www/html/admin/scripts/pi-hole/php/loginpage.php
...
sudo rpl 'Blocking disabled</span>' 'Blockierung ist aus!</span>' /var/www/html/admin/scripts/pi-hole/php/header.php
...
sudo rpl 'There are' 'Es gibt' /var/www/html/admin/scripts/pi-hole/js/utils.js
sudo rpl 'warnings.' 'Warnungen.' /var/www/html/admin/scripts/pi-hole/js/utils.js
sudo rpl 'There is one warning.' 'Es gibt eine Warnung.' /var/www/html/admin/scripts/pi-hole/js/utils.js
...
sudo rpl '/i> Custom time' '/i> Benutzerdefinierte Zeit' /var/www/html/admin/scripts/pi-hole/php/header.php
...
sudo rpl '</i> Search Adlists' '</i> Blocklisten durchsuchen' /var/www/html/admin/scripts/pi-hole/php/header.php
sudo rpl '</i> Audit log' '</i> Prüfprotokoll' /var/www/html/admin/scripts/pi-hole/php/header.php
sudo rpl 'Tail pihole.log' 'pihole.log anzeigen' /var/www/html/admin/scripts/pi-hole/php/header.php
...
sudo rpl 'title="List' 'title="Liste der' /var/www/html/admin/scripts/pi-hole/js/index.js
sudo rpl ' queries"' ' Anfragen"' /var/www/html/admin/scripts/pi-hole/js/index.js
...
sudo rpl 'Access "Tools' 'Weitere Einzelheiten unter "Tools' /var/www/html/admin/scripts/pi-hole/js/utils.js
sudo rpl 'Pi-hole diganosis' 'Pi-hole Diagnose' /var/www/html/admin/scripts/pi-hole/js/utils.js
sudo rpl ' for further details.' '.' /var/www/html/admin/scripts/pi-hole/js/utils.js
...
sudo rpl '\(sent to ' '(gesendet an ' /var/www/html/admin/scripts/pi-hole/js/queries.js
sudo rpl '\(answered by ' '(beantwortet von ' /var/www/html/admin/scripts/pi-hole/js/queries.js
...
sudo rpl 'Blocked <br' 'Geblockt <br' /var/www/html/admin/scripts/pi-hole/js/db_queries.js
sudo rpl "\(regex blacklist, CNAME\)" "(RegEx Blacklist, CNAME)" /var/www/html/admin/scripts/pi-hole/js/db_queries.js
sudo rpl "\(exact blacklist, CNAME\)" "(exakte Blacklist, CNAME)" /var/www/html/admin/scripts/pi-hole/js/db_queries.js
...
sudo rpl "\(special domain\)" "(spezielle Domain)" /var/www/html/admin/scripts/pi-hole/js/db_queries.js
...
sudo rpl 'Note:' 'Hinweis:' /var/www/html/admin/groups-domains.php
sudo rpl 'The  Domain oder eines RegEx Filters  will be automatically assigned to the Default Group' 'Die Domäne oder ein RegEx-Filter wird automatisch der Standardgruppe zugewiesen' /var/www/html/admin/groups-domains.php
sudo rpl 'Other groups can optionally be assigned' 'Andere Gruppen können optional zugewiesen werden' /var/www/html/admin/groups-domains.php
sudo rpl 'within \<a' 'unter <a' /var/www/html/admin/groups-domains.php
sudo rpl 'Group Management \> Domains' 'Gruppenverwaltung > Domains' /var/www/html/admin/groups-domains.php
sudo rpl 'in the list below \(using ' 'in der folgenden Liste (mit ' /var/www/html/admin/groups-domains.php
sudo rpl 'Group assignment' 'Gruppenzuweisung' /var/www/html/admin/groups-domains.php
...
sudo rpl 'skipped duplicates' 'Duplikate übersprungen' /var/www/html/admin/scripts/pi-hole/php/groups.php
...
sudo rpl 'Invalid adlist URL' 'Ungültige Blockliste' /var/www/html/admin/scripts/pi-hole/php/groups.php
sudo rpl 'adlists"\)' 'Blocklisten")' /var/www/html/admin/scripts/pi-hole/php/groups.php
sudo rpl 'Ignored duplicated adlists' 'Ignorierte doppelte Blocklisten' /var/www/html/admin/scripts/pi-hole/php/groups.php
...
sudo rpl 'is configured with special group settings' 'ist mit speziellen Gruppeneinstellungen konfiguriert' /var/www/html/admin/scripts/pi-hole/php/groups.php
sudo rpl 'Please modify the domain on the respective group management pages' 'Bitte ändern Sie die Domain auf den jeweiligen Gruppenverwaltungsseiten' /var/www/html/admin/scripts/pi-hole/php/groups.php
...
sudo rpl 'Error while adding new group' 'Fehler beim Hinzufügen einer neuen Gruppe.' /var/www/html/admin/scripts/pi-hole/js/groups.js
...
sudo rpl '"Error while " \+ notDone' '"Fehler während " + notDone' /var/www/html/admin/scripts/pi-hole/js/groups.js
sudo rpl 'Deleting group...' 'Gruppe wird gelöscht ...' /var/www/html/admin/scripts/pi-hole/js/groups.js
sudo rpl 'Successfully deleted groups' 'Gruppen erfolgreich gelöscht!' /var/www/html/admin/scripts/pi-hole/js/groups.js
sudo rpl 'Reset sorting</button>' 'Sortierung zurücksetzen</button>' /var/www/html/admin/groups.php
sudo rpl 'Error while deleting groups' 'Fehler beim Löschen von Gruppen.' /var/www/html/admin/scripts/pi-hole/js/groups.js
...
sudo rpl 'Remove all items' 'Alle Einträge entfernen' /var/www/html/admin/scripts/vendor/select2.min.js
...
sudo rpl '"fas fa-plus", "Warning"' '"fas fa-plus", "Achtung!"' /var/www/html/admin/scripts/pi-hole/js/groups-adlists.js
...
sudo rpl '<br><b>Total: " . \$total . " adlist\(s\) processed.</b>' '<br><b>Insgesamt: " . $total . " Blockliste(n) bearbeitet.</b>' /var/www/html/admin/scripts/pi-hole/php/groups.php
...
sudo rpl 'List download was successful \(<span class="list-status-1">OK</span>\)' 'Das Herunterladen der Liste war erfolgreich. (<span class="list-status-1">OK</span>)' /var/www/html/admin/scripts/pi-hole/js/groups-adlists.js
...
sudo rpl '"Deleting Adlists: "' '"Lösche die Blockliste: "' /var/www/html/admin/scripts/pi-hole/js/groups-adlists.js
...
sudo rpl 'Error while deleting adlists' 'Fehler beim Löschen von Blocklisten.' /var/www/html/admin/scripts/pi-hole/js/groups-adlists.js
...
sudo rpl 'Warning in <code>dnsmasq</code> core:<pre>' 'Warnung im <code>dnsmasq</code> Kern:<pre>' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Check out ' 'Für mehr Informationen sehen Sie sich unsere ' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'our documentation' 'Dokumentation ' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl ' for further information' 'an' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Long-term load \(15min avg\) larger than number of processors' 'Langfristige Belastung (15min Durchschnitt) ist größer als die Anzahl der Prozessoren' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'This may slow down DNS resolution and can cause bottlenecks' 'Dies kann die DNS-Auflösung verlangsamen und zu Engpässen führen.' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'RAM shortage ' 'Zu wenig Arbeitsspeicher ' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'ahead:' 'es werden annähernd' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl '% used' '% benutzt' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Disk shortage' 'Zu wenig Festplattenspeicher' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl '"Select All"' '"Alle auswählen"' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl '"Deselect All"' '"Alle abwählen"' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl '"Delete Selected"' '"Ausgewählte löschen"' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Unknown message type<pre>' 'Unbekannte Mitteilung type<pre>' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Deleting messages:' 'Gelöschte Mitteilung:' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Successfully deleted messages:' 'Erfolgreich gelöschte Mitteilungen:' /var/www/html/admin/scripts/pi-hole/js/messages.js
sudo rpl 'Error while deleting message:' 'Fehler beim Löschen der Mitteilung:' /var/www/html/admin/scripts/pi-hole/js/messages.js
...
sudo rpl 'Using libz compression' 'Verwenden der libz-Komprimierung' /opt/pihole/gravity.sh
...
sudo rpl 'Creating new gravity databases' 'Erstellen einer neuen Gravity Datenbank' /opt/pihole/gravity.sh
...
sudo rpl 'Unable to copy data from' 'Daten konnten nicht kopiert werden von' /opt/pihole/gravity.sh
sudo rpl 'gravityDBfile} to' 'gravityDBfile} bis' /opt/pihole/gravity.sh
...
sudo rpl 'Domain to look for \(example.com or sub.example.com\)' 'zu suchende Domain (beispiel.com oder mobil.beispiel.com)' /var/www/html/admin/queryads.php
...
sudo rpl 'Output the last lines of the FTL.log file \(live\)' 'Ausgabe der letzten Zeilen der Datei FTL.log (live)' /var/www/html/admin/taillog-FTL.php
...
sudo rpl 'Upload debug log and provide token \(shown at the end of the report\) once finished' 'Laden Sie das Debug-Protokoll hoch und stellen Sie das Token bereit (wird am Ende des Berichts angezeigt), sobald es fertig ist.' /var/www/html/admin/debug.php
...
sudo rpl 'No host name for' 'Kein Hostname für' /var/www/html/admin/scripts/pi-hole/js/network.js
sudo rpl '" known"\)' '" bekannt")' /var/www/html/admin/scripts/pi-hole/js/network.js
...
sudo rpl 'Rate-limiting' 'Anfragebeschränkung' /var/www/html/admin/settings.php
sudo rpl 'Block clients making more than' 'Blockieren Sie Geräte, die mehr als ' /var/www/html/admin/settings.php
sudo rpl 'queries within' 'Anfragen innerhalb von ' /var/www/html/admin/settings.php
sudo rpl 'seconds.</p>' 'Sekunden stellen.</p>' /var/www/html/admin/settings.php



sudo rpl 'When a client makes too many queries in too short time, it' 'Wenn ein Gerät in kurzer Zeit zu viele Anfragen stellt, werden Anfragen' /var/www/html/admin/settings.php
sudo rpl 'gets rate-limited. Rate-limited queries are answered with a' 'begrenzt. Begrenzte Anfragen werden mit Antwort <code>VERWEIGERT</code>' /var/www/html/admin/settings.php
sudo rpl '<code>REFUSED<\/code> reply and not further processed by FTL' 'beantwortet und von der FTL nicht weiter bearbeitet, um zu verhindern,' /var/www/html/admin/settings.php
sudo rpl 'and prevent Pi-holes getting overwhelmed by rogue clients.' 'dass Pi-hole von bösartigen Geräten überwältigt werden kann. Es ist wichtig' /var/www/html/admin/settings.php
sudo rpl 'It is important to note that rate-limiting is happening on a' 'zu beachten, dass die Anfragebegrenzung pro Gerät erfolgt. Andere Geräte können' /var/www/html/admin/settings.php
sudo rpl 'per-client basis. Other clients can continue to use FTL while' 'FTL währenddessen weiterhin verwenden. Anfragebegrenzte Geräte werden gleichzeitig' /var/www/html/admin/settings.php
sudo rpl 'rate-limited clients are short-circuited at the same time.' 'kurzgeschlossen.' /var/www/html/admin/settings.php
sudo rpl 'Anfragebeschränkung may be disabled altogether by setting both' 'Die Anfragebeschränkung kann vollständig deaktiviert werden,' /var/www/html/admin/settings.php
sudo rpl 'values to zero. See' 'indem beide Werte auf Null gesetzt werden.' /var/www/html/admin/settings.php
sudo rpl '<a href="https://docs.pi-hole.net/ftldns/configfile/#rate_limit" target="_blank">our documentation</a>' 'Siehe <a href="https://docs.pi-hole.net/ftldns/configfile/#rate_limit"target="_blank">unsere Dokumentation</a>' /var/www/html/admin/settings.php
sudo rpl 'for further details.' 'für weitere Details.' /var/www/html/admin/settings.php
...
sudo rpl "If not configured as your DHCP server, Pi-hole typically won't be able to" 'Wenn Pi-hole nicht als DHCP-Server konfiguriert ist, kann' /var/www/html/admin/settings.php
...
sudo rpl 'when "Never forward non-FQDNs" is <em>not</em> enabled.' 'wenn "Never forward non-FQDNs" <em>nicht</em> aktiviert ist.' /var/www/html/admin/settings.php
...
sudo rpl 'Per-browser settings \(auto saved\)' 'Browser Aussehen wird automatisch gespeichert' /var/www/html/admin/settings.php
...
sudo rpl 'Hide non-fatal ' 'Unproblematische ' /var/www/html/admin/settings.php
sudo rpl 'warnings \(warnings listed' 'Warnungen ausblenden (Warnungen siehe ' /var/www/html/admin/settings.php
sudo rpl '>here' '>hier' /var/www/html/admin/settings.php
...
sudo rpl 'Adding custom DNS entry...' 'Hinzufügen eines eigenen DNS-Eintrags ...' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Custom DNS added' 'Eigener DNS hinzugefügt' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Failure! Something went wrong' 'Fehler! Etwas ging schief.' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Error while adding custom DNS entry' 'Fehler beim Hinzufügen eines eigene DNS-Eintrags.' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Deleting custom DNS entry...' 'Löschen des eigenen DNS-Eintrags ...' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Custom DNS deleted' 'Eigener DNS-Eintrag gelöscht.' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl 'Error while deleting custom DNS entry' 'Fehler beim Löschen des eigenen DNS-Eintrags.' /var/www/html/admin/scripts/pi-hole/js/customdns.js
sudo rpl '' '' /var/www/html/admin/scripts/pi-hole/js/customdns.js
...
rpl '" with "' '"   nicht ersetzt durch   "' /tmp/error2-translate.log
echo >> /tmp/error2-translate.log
echo >> /tmp/error2-translate.log
